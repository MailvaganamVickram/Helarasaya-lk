...
const PaymentSuccess = () => {
  ...
  return (
    <section className='section__container rounded p-6 bg-white shadow-lg'>
        ...
        <p className='mb-8'>Status: {order?.status}</p> 
         ...
         <ol className='timeline-container sm:flex items-center relative space-x-8 sm:space-x-6'>
            {
